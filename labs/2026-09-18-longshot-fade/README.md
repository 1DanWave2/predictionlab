...
<!-- auto:datawindow -->
*Data refreshes nightly: as of 2026-09-21 09:07 UTC there are 186,871 markets with observations and 783,312 observations. The tables below are recomputed on that data; the prose was written on 2026-09-18 (182,503 markets) and is revised by hand when a headline number changes sign.*
<!-- /auto:datawindow -->
...
|---|---|---|---|---|---|---|
| under 5¢ | 49,155 | 1.29% | 1.26% | +0.03% [-0.06, +0.13] | -0.04% | -1.04% |
| 5–10¢ | 13,839 | 7.26% | 8.91% | -1.78% [-2.32, -1.26] | -2.15% | -3.19% |
| 10–20¢ | 23,335 | 15.00% | 17.22% | -2.62% [-3.20, -2.04] | -3.36% | -4.47% |
| all under 20¢ | 86,329 | 5.95% | 6.80% | -0.90% [-1.07, -0.74] | -1.19% | -2.22% |
<!-- /auto:table_h1_bands -->
...
|---|---|---|---|
| sports (n = 37,723) | 8.98% | 10.97% | -2.18% [-2.52, -1.86] |
| politics and macro (n = 5,074) | 4.12% | 5.14% | -1.07% [-1.66, -0.47] |
| crypto (n = 18,848) | 3.28% | 3.66% | -0.40% [-0.65, -0.12] |
| culture (n = 4,080) | 2.64% | 2.01% | +0.65% [+0.21, +1.07] |
| other (n = 20,604) | 3.95% | 3.39% | +0.59% [+0.34, +0.83] |
| lowest volume tercile | 6.32% | 5.94% | +0.40% [+0.13, +0.68] |
| highest volume tercile | 5.41% | 7.37% | -2.07% [-2.37, -1.78] |
| market lifetime over 60 days | 1.98% | 1.34% | +0.65% [+0.39, +0.88] |
| market lifetime 3–14 days | 6.61% | 7.82% | -1.30% [-1.54, -1.05] |
| binary market | 6.79% | 8.65% | -2.00% [-2.29, -1.72] |
