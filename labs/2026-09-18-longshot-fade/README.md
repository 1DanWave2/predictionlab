...
<!-- auto:datawindow -->
*Data refreshes nightly: as of 2026-09-22 08:41 UTC there are 187,326 markets with observations and 785,281 observations. The tables below are recomputed on that data; the prose was written on 2026-09-18 (182,503 markets) and is revised by hand when a headline number changes sign.*
<!-- /auto:datawindow -->
...
|---|---|---|---|---|---|---|
| under 5¢ | 49,269 | 1.29% | 1.26% | +0.03% [-0.06, +0.13] | -0.04% | -1.04% |
| 5–10¢ | 13,879 | 7.25% | 8.92% | -1.80% [-2.31, -1.29] | -2.16% | -3.20% |
| 10–20¢ | 23,399 | 15.00% | 17.21% | -2.61% [-3.16, -2.07] | -3.35% | -4.46% |
| all under 20¢ | 86,547 | 5.95% | 6.80% | -0.90% [-1.07, -0.72] | -1.19% | -2.22% |
<!-- /auto:table_h1_bands -->
...
|---|---|---|---|
| 1 | +0.03% / -1.04% (n=49,269) | -1.80% / -3.20% (n=13,879) | -2.61% / -4.46% (n=23,399) |
| 2 | +0.04% / -1.04% (n=40,286) | -1.42% / -2.84% (n=12,450) | -2.69% / -4.56% (n=20,884) |
| 3 | +0.07% / -1.02% (n=34,958) | -1.46% / -2.88% (n=11,490) | -1.92% / -3.81% (n=19,375) |
| 5 | +0.18% / -0.92% (n=28,169) | -1.28% / -2.72% (n=10,721) | -1.46% / -3.37% (n=17,023) |
| 7 | +0.44% / -0.63% (n=16,984) | -0.50% / -1.90% (n=5,707) | -1.46% / -3.30% (n=8,520) |
| 14 | +0.59% / -0.49% (n=13,016) | +0.48% / -0.93% (n=3,490) | +0.72% / -1.13% (n=3,470) |
| 30 | +0.70% / -0.38% (n=8,293) | +2.14% / +0.71% (n=2,220) | +2.65% / +0.79% (n=2,625) |
<!-- /auto:table_horizons -->
...
|---|---|---|---|
| sports (n = 37,785) | 8.98% | 10.97% | -2.19% [-2.51, -1.86] |
| politics and macro (n = 5,152) | 4.14% | 5.09% | -0.99% [-1.57, -0.39] |
| crypto (n = 18,885) | 3.28% | 3.67% | -0.41% [-0.67, -0.15] |
| culture (n = 4,087) | 2.65% | 2.01% | +0.66% [+0.25, +1.07] |
| other (n = 20,638) | 3.96% | 3.39% | +0.59% [+0.35, +0.84] |
| lowest volume tercile | 6.32% | 5.96% | +0.39% [+0.11, +0.67] |
| highest volume tercile | 5.41% | 7.37% | -2.07% [-2.36, -1.78] |
| market lifetime over 60 days | 1.98% | 1.34% | +0.66% [+0.42, +0.90] |
| market lifetime 3–14 days | 6.61% | 7.84% | -1.31% [-1.54, -1.08] |
| binary market | 6.79% | 8.66% | -2.01% [-2.29, -1.72] |
| negative-risk group member | 5.29% | 5.31% | -0.03% [-0.24, +0.18] |
<!-- /auto:table_h1_cuts -->
